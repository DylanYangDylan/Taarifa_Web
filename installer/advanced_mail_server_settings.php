				...
				<table class="form-table fields">
					<tbody>
						<tr>
							...
							<td><input type="text" value="<?php print $form->value('site_alert_email') == "" ? !empty($_SESSION['site_alert_email']) : $form->value('site_alert_email'); ?>" size="25" id="site_alert_email" name="site_alert_email"/></td>
						...
						<tr>
							...
							<td><input type="text" value="<?php print $form->value('mail_server_username') == "" ? !empty($_SESSION['mail_server_username']) : $form->value('mail_server_username'); ?>" size="25" id="mail_server_username" name="mail_server_username"/></td>
						...
						<tr>
							...
							<td><input type="password" value="<?php print $form->value('mail_server_pwd') == "" ? !empty($_SESSION['mail_server_pwd']) : $form->value('mail_server_pwd'); ?>" size="25" id="mail_server_pwd" name="mail_server_pwd"/></td>
						...
						<tr>
							...
							<td><input type="text" value="<?php print $form->value('mail_server_port') == "" ? !empty($_SESSION['mail_server_port']): $form->value('mail_server_port'); ?>" size="25" id="mail_server_port" name="mail_server_port"/></td>
						...
						<tr>
							...
							<td><input type="text" value="<?php print $form->value('mail_server_host') == "" ? !empty($_SESSION['mail_server_host']): $form->value('mail_server_host'); ?>" size="25" id="mail_server_host" name="mail_server_host"/></td>
